...
def CoefficientOfDev(ethnicity, gender, freeSchoolMeals, senType, senGroup, admissionType, schoolCharacteristic, religion, value):
    ...
    plt.xticks(rotation = 40, ha= "right")#function for rotating the group names for a better design
    axs.yaxis.grid()

    plt.tight_layout()
    plt.show()
    print(CoefVariableList)     
...
def TotalPassing(ethnicity, gender, freeSchoolMeals, senType, senGroup, admissionType, schoolCharacteristic, religion, value):
    ...
    ax.set_title("GCSE passing percentage Results 2019-20", fontsize=14)
    ax.set_xlabel("Group types", fontsize=12)
    ax.set_ylabel("GCSE passing percentage(%)", fontsize=12)
     
    ax.bar(variableList, valueList, width= 0.5, color= "red")
...
def averages(ethnicity, gender, freeSchoolMeals, senType, senGroup, admissionType, schoolCharacteristic, religion, value):
    ...
    ax.set_title("GCSE average percentage Results 2019-20", fontsize=14)
    ax.set_xlabel("Group types", fontsize=12)
    ax.set_ylabel("GCSE average percentage(%)", fontsize=12)

     
    ax.bar(resultNames, resultValues, width= 0.5, color= "red")
